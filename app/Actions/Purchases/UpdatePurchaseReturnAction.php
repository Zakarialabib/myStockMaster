...
final class UpdatePurchaseReturnAction
{
    public function __invoke(PurchaseReturn $purchaseReturn, array $data, iterable $cartItems, float|int $cartTax, float|int $cartDiscount): PurchaseReturn
    {
