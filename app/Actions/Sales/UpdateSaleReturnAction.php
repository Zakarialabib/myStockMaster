...
final class UpdateSaleReturnAction
{
    public function __invoke(SaleReturn $saleReturn, array $data, iterable $cartItems, float|int $cartTax, float|int $cartDiscount): SaleReturn
    {
