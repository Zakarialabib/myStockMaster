...
<div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            @if (session('resent'))
                <div class="flex items-center px-4 py-3 mb-6 text-sm text-white bg-green-500 rounded-sm shadow"
                    role="alert">
            ...
            <div class="text-sm text-gray-700">
                ...
                <p class="mt-3">
                    If you did not receive the email, <buttom wire:click="sendVerification"
                        class="text-indigo-700 cursor-pointer hover:text-indigo-600 focus:outline-hidden focus:underline transition ease-in-out duration-150">
