<div 
    ...
    x-init="setInterval(() => checkConnection(), 30000)" 
...
>
    ...
    <button 
        ...
        :class="$wire.isOnline ? 'bg-green-500 hover:bg-green-600 focus:ring-green-500' : 'bg-red-500 hover:bg-red-600 focus:ring-red-500'"
    >
