                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="p-4">
                        ...
                        <form wire:submit.prevent="proceed">
                            <div class="flex flex-wrap -mx-2 mb-3">
                                <div class="w-full md:w-1/3 px-2 mb-2">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" wire:model.blur="form.reference" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" readonly value="SLRN" />
                                    </div>
                                </div>
                                <div class="w-full md:w-1/3 px-2 mb-2">
                                    <div class="mb-4">
                                        <label for="customer_id" class="block text-sm font-medium text-gray-700">{{ __('Customer') }} <span class="text-red-500">*</span></label>
                                        <x-select wire:model.blur="form.customer_id" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" required>
                            ...
                            <livewire:utils.product-cart :cartInstance="'sale_return'" />
                            ...
                            <div class="mt-4 flex justify-end">
                                <button type="submit" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" wire:loading.attr="disabled">
                                    <span wire:loading.remove>{{ __('Create Sale Return') }}</span>
