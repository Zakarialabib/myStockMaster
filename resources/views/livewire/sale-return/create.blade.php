                            ...
                            <div class="flex flex-wrap -mx-2 mb-3">
                                <div class="w-full md:w-1/3 px-2 mb-2">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" wire:model.blur="reference" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" readonly value="SLRN" />
                                    </div>
                                </div>
                                <div class="w-full md:w-1/3 px-2 mb-2">
                                    <div class="mb-4">
