        ...
        <x-slot name="content">
            ...
            <form wire:submit.prevent="create">
                <div class="flex flex-wrap">
                    <div class="w-full lg:w-1/2 px-2 mb-2 lg:mb-0">
                    ...
                    <div class="flex items-center justify-start  space-x-4 my-4 w-full">
                        <x-button primary wire:click="create" wire:loading.attr="disabled">
                            {{ __('Create') }}
                        </x-button>
                        <x-button secondary wire:click="$set('createSupplier', false)" wire:loading.attr="disabled">
                            {{ __('Cancel') }}
                        </x-button>
                    </div>
                </div>
