<div x-data="{ isCartOpen: false }" @keydown.window.ctrl.s.prevent="$wire.store()">
    ...
    <x-theme.breadcrumb :title="__('Create Purchase Return')" :parent="route('purchase-returns.index')" :parentName="__('Purchase Returns List')" :childrenName="__('Create Purchase Return')">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <x-searchable-select required id="supplier_id" name="supplier_id" wire:model.live="form.supplier_id" :options="$this->suppliers" />
                        </div>
        ...
        <div class="lg:col-span-5 flex flex-col gap-4 overflow-y-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 flex-1 flex flex-col min-h-[300px]">
                ...
                <div class="p-0 flex-1 overflow-y-auto">
                    <livewire:utils.product-cart :cartInstance="'purchase_return'" :warehouseId="$form->warehouse_id" />
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <div class="flex mt-1">
                            <x-input id="paid_amount" type="number" step="0.01" wire:model.live.debounce.300ms="form.paid_amount" name="paid_amount" class="w-full rounded-r-none" required />
                            <button wire:click="$set('form.paid_amount', {{ $form->total_amount }})" type="button" class="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 dark:border-gray-600 rounded-r-md bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600 focus:outline-none">
