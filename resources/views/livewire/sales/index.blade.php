                    ...
                    <x-table.td>
                        <div class="flex justify-start space-x-2">
                            <x-dropdown align="right" class="w-auto">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link wire:click="showModal({{ $sale->id }})" wire:loading.attr="disabled">
                                        <i class="fas fa-eye"></i>
                                        {{ __('View') }}
                                    </x-dropdown-link>
                                    @can('edit_sales')
                                    <x-dropdown-link href="{{ route('sales.edit', $sale) }}" wire:loading.attr="disabled">
                                        <i class="fas fa-edit"></i>
                                        {{ __('Edit') }}
                                    </x-dropdown-link>
                                    @endcan
                                    @can('delete_sales')
                                    <x-dropdown-link href="{{ route('sales.destroy', $sale) }}"
                            ...
                            <x-dropdown-link wire:click="showPayments({{ $sale->id }})" primary wire:loading.attr="disabled">
