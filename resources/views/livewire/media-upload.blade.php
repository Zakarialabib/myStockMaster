                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="font-light text-zinc-500">
                                ...
                                <div class="flex space-x-2 mt-2">
                                    ...
                                    <button type="button" wire:click="removeSingle" class="px-3 py-1 text-xs text-red-500 border border-red-400 rounded hover:bg-red-50 transition">
                                        {{__('Remove')}}
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            @foreach ($file as $index => $f)
                                <div class="flex flex-col items-center space-y-2 relative group">
                                    ...
                                    <button type="button" wire:click="removeMultiple({{ $index }})" class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 shadow-md opacity-0 group-hover:opacity-100 transition-opacity">
