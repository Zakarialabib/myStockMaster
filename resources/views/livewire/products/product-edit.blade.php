            ...
            <form id="product-form" action="{{ route('products.update', $product->id) }}" method="POST"
                ...
                <div class="flex flex-wrap -mx-1">
                    ...
                    <div class="lg:w-1/2 sm:w-1/2 px-2">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded"
                                name="code" required value="{{ $product->code }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-1">
                    ...
                    <div class="flex flex-wrap -mx-1">
                        <div class="lg:w-1/2 sm:w-1/2 px-2">
                            <div class="mb-4">
                                <label for="cost">{{ __('Cost') }} <span class="text-danger">*</span></label>
                                <input id="cost" type="text"
                                    class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded"
                                    min="0" name="cost" required value="{{ $product->cost }}">
                            </div>
                        </div>
                        <div class="lg:w-1/2 sm:w-1/2 px-2">
                            <div class="mb-4">
                                ...
                                <input id="price" type="text"
                                    class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded"
                                    min="0" name="price" required value="{{ $product->price }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-1">
                        <div class="lg:w-1/2 sm:w-1/2 px-2">
                            <div class="mb-4">
                                ...
                                <input type="number"
                                    class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded"
                                    name="quantity" required value="{{ $product->quantity }}" min="1">
                            </div>
                        </div>
                        <div class="lg:w-1/2 sm:w-1/2 px-2">
                            <div class="mb-4">
                                ...
                                <input type="number"
                                    class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded"
                                    name="stock_alert" required value="{{ $product->stock_alert }}" min="0">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-wrap -mx-1">
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number"
                                        class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded"
                                        name="order_tax" value="{{ $product->order_tax }}" min="0"
                                        max="100">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <select
                                        ...
                                        <option {{ $product->tax_type == 1 ? 'selected' : '' }} value="1">
                                            {{ __('Exclusive') }}</option>
                                        <option {{ $product->tax_type == 2 ? 'selected' : '' }} value="2">
                                            {{ __('Inclusive') }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <select
                                    ...
                                    <option selected {{ $product->barcode_symbology == 'C128' ? 'selected' : '' }}
                                        value="C128">Code 128</option>
                                    <option {{ $product->barcode_symbology == 'C39' ? 'selected' : '' }}
                                        value="C39">Code 39</option>
                                    <option {{ $product->barcode_symbology == 'UPCA' ? 'selected' : '' }}
                                        value="UPCA">UPC-A</option>
                                    <option {{ $product->barcode_symbology == 'UPCE' ? 'selected' : '' }}
                                        value="UPCE">UPC-E</option>
                                    <option {{ $product->barcode_symbology == 'EAN13' ? 'selected' : '' }}
                                        value="EAN13">EAN-13</option>
                                    <option {{ $product->barcode_symbology == 'EAN8' ? 'selected' : '' }}
                            ...
                            <div class="w-full mb-4">
                                ...
                                <textarea name="note" id="note" rows="4 "
                                    class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded">{{ $product->note }}</textarea>
                            </div>
                        </div>
                    </x-accordion>
                ...
                <div class="w-full px-4">
                    ...
                    <div class="mb-4">
                        <button
                            class="block uppercase mx-auto shadow bg-indigo-800 hover:bg-indigo-700 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded">{{ __('Update') }}<i
