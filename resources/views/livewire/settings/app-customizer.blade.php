            ...
            <div class="mt-8">
                ...
                <div class="p-6 border rounded-lg" style="font-family: {{ $font_family }};">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style="background-color: {{ $primary_color }};">
                            A
                        </div>
                        <div>
                            <h5 class="font-bold text-lg" style="color: {{ $primary_color }};">Heading Example</h5>
                            <p class="text-gray-600 text-sm">This is how your selected font family looks.</p>
                        </div>
                    </div>
                    <button type="button" class="px-4 py-2 text-white rounded-md text-sm font-medium transition-colors" style="background-color: {{ $primary_color }};">
                        Primary Button
                    </button>
                </div>
            </div>
