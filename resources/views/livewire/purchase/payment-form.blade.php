            ...
            <form wire:submit.prevent="paymentSave">
                <div class="flex flex-wrap -mx-2 mb-3">
                    <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                        ...
                        <input type="date" wire:model.lazy="date" id="date" class="block w-full mt-1" required>
                        <x-input-error :messages="$errors->first('date')" />
                    </div>
                    <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                        <x-label for="amount" :value="__('Amount')" required />
                        <x-input type="text" wire:model.lazy="amount" id="amount" class="block w-full mt-1"
                            required />
