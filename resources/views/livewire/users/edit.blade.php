<div>
    <x-modal wire:model="form.showModal">
        <x-slot name="title">
            {{ __('Edit User') }}
        </x-slot>
            ...
            <form wire:submit="update" class="space-y-4">
                ...
                <div>
                    ...
                    <x-select-list
                        ...
                        required id="role" name="role" wire:model="form.role" :options="$this->roles" />
                ...
                <div>
                    ...
                    <x-select-list multiple
                        ...
                        wire:model="form.warehouse_id" :options="$this->warehouses" />
