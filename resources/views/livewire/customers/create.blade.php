            ...
            <form wire:submit="create" class="space-y-4">
                <div class="grid sm:grid-cols-2 gap-4">
                    <div class="w-full">
                        ...
                        <x-input id="name" class="block mt-1 w-full" required type="text" wire:model="form.name" />
                    ...
                    <div class="w-full">
                        ...
                        <x-input-error :messages="$errors->get('form.phone')" for="form.phone" class="mt-2" />
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <x-input-error :messages="$errors->get('form.tax_number')" class="mt-2" />
                    </div>
                </div>
