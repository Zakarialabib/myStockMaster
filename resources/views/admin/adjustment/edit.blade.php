    ...
    <div class="flex flex-wrap items-center">
        <div class="mb-5 lg:mb-0">
            ...
            <div class="flex items-center">
                ...
                <a class="flex items-center text-sm" href="{{ route('adjustments.index') }}">
                    <span class="inline-block mr-2">
                    ...
                    <div class="p-4">
                        ...
                        <form action="{{ route('adjustments.update', $adjustment) }}" method="POST">
                            ...
                            <div class="flex flex-wrap -mx-1">
                                <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded" name="reference" required value="{{ $adjustment->getAttributes()['reference'] }}" readonly>
                                    </div>
                                </div>
                                <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-4">
                                    <div class="from-group">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded" name="date" required value="{{ $adjustment->getAttributes()['date'] }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="note" id="note" rows="5" class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded">
                                    {{ $adjustment->note }}
                                </textarea>
                            </div>
                            <div class="mt-3">
