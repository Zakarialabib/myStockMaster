                    ...
                    <div class="p-4">
                        ...
                        <form id="purchase-return-form" action="{{ route('purchase-returns.store') }}" method="POST">
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                                    <div class="from-group">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" name="date" required value="{{ now()->format('Y-m-d') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            <input id="paid_amount" type="text" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" name="paid_amount" required>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="note" id="note" rows="5" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"></textarea>
                            </div>
