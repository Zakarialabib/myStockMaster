                    ...
                    <div class="p-4">
                        ...
                        <form id="purchase-return-form" action="{{ route('purchase-returns.update', $purchase_return) }}" method="POST">
                            ...
                            <div class="flex flex-wrap -mx-2 mb-3">
                                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" name="reference" required value="{{ $purchase_return->reference }}" readonly>
                                    </div>
                                </div>
                                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                                    <div class="from-group">
                                        <div class="mb-4">
                                            ...
                                            <select class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" name="supplier_id" id="supplier_id" required>
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                                    <div class="from-group">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" name="date" required value="{{ $purchase_return->date }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                                    <div class="from-group">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" name="payment_method" required value="{{ $purchase_return->payment_method }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="w-full md:w-1/3 px-3 mb-4 md:mb-0">
                                    <div class="mb-4">
                                        ...
                                        <input id="paid_amount" type="text" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1" name="paid_amount" required value="{{ $purchase_return->paid_amount }}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="note" id="note" rows="5" class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1">{{ $purchase_return->note }}</textarea>
                            </div>
