                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="product_access" {{ $role->hasPermissionTo('product_access') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="product_access">Access</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="product_update" {{ $role->hasPermissionTo('product_update') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="quotation_update" {{ $role->hasPermissionTo('quotation_update') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="quotation_delete" {{ $role->hasPermissionTo('quotation_delete') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="quotation_delete">Delete</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="purchase_access" {{ $role->hasPermissionTo('purchase_access') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="purchase_access">View</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="purchase_update" {{ $role->hasPermissionTo('purchase_update') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="purchase_delete" {{ $role->hasPermissionTo('purchase_delete') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="purchase_delete">Delete</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
