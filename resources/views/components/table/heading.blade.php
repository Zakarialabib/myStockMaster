...
>
    ...
    @else
        <button {{ $attributes->except('class') }} class="flex items-center space-x-1.5 text-center text-xs font-medium uppercase group focus:outline-none focus:underline w-full">
            <span>{{ $slot }}</span>
