<div>
    <div class="p-3 group hover:bg-{{$color}}-500 cursor-pointer hover:shadow-xl border bg-white hover:border-{{$color}}-500 duration-200 ease-in-out transition-all flex items-center rounded-md overflow-hidden sm:rounded-md w-full">
