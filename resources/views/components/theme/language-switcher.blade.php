<div class="self-center relative" x-data="{ langSwitcher: false }">
    ...
    <div x-show="langSwitcher" @click.away="langSwitcher = false"
        class="flex flex-col bg-white text-gray-500 focus:ring-3 focus:ring-offset-2 focus:ring-blue-500 transition-colors float-left py-2 min-w-48 absolute right-0 z-50 mt-2  rounded-md shadow-lg overflow-y-auto"
